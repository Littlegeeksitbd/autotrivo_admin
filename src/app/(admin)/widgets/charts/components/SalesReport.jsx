            ...
            <div className="grid md:grid-cols-3 grid-cols-2 md:gap-base text-center">
              <div>
                ...
                <h4 className="flex justify-center items-center mb-4 text-lg font-semibold">
                  <Icon icon="wallet" className="text-success me-1.25" />
                  <span>
                    <CountUp start={0} end={72224.68} duration={1} prefix="$" />
                  </span>
                </h4>
              </div>
              <div>
                ...
                <h4 className="flex justify-center items-center mb-4 text-lg font-semibold">
                  <Icon icon="basket" className="text-success me-1.25" />
                  <span>
              ...
              <div>
                ...
                <h4 className="flex justify-center items-center mb-4 text-lg font-semibold">
                  <Icon icon="trending-up" className="text-success me-1.25" />
                  <span>
                    <CountUp start={0} end={25.3} duration={1} suffix="%" />
                  </span>
                </h4>
              </div>
            </div>
