...
export const messageThreadData = [
  {
    id: 't1',
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: 'm36',
        senderId: currentUser.id,
        text: 'Yes, they’re showing now. Looks good.',
        time: '10:22 am',
      },
      {
        id: 'm37',
        senderId: contactData[3].id,
        text: 'Cool. I’ll push to staging then.',
        time: '10:30 am',
      },
    ],
  },
  {
    ...
    messages: [
      {
        id: 'm38',
        senderId: contactData[4].id,
        text: 'Want to sync on the timeline tomorrow morning?',
        time: '11:00 am',
      },
      {
        id: 'm39',
        senderId: currentUser.id,
        text: 'Yes, let’s do 10:30 AM.',
        time: '11:02 am',
      },
      {
        id: 'm40',
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: 'm42',
        senderId: currentUser.id,
        text: 'Great, assign it to me once ready.',
        time: '11:35 am',
      },
      {
        id: 'm43',
        senderId: contactData[5].id,
        text: 'Done. Ticket #4582.',
        time: '11:38 am',
      },
    ],
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: 'm45',
        senderId: currentUser.id,
        text: 'I’ll start on that after lunch.',
        time: '12:18 pm',
      },
      {
        id: 'm46',
        senderId: contactData[6].id,
        text: 'Cool. I’ll update the Jira board.',
        time: '12:20 pm',
      },
    ],
  },
  {
    ...
    messages: [
      {
        id: 'm47',
        senderId: contactData[7].id,
        text: 'Make sure to sanitize the inputs in that form.',
        time: '01:05 pm',
      },
      {
        id: 'm48',
        senderId: currentUser.id,
        text: 'Yup, I’ll add validations today.',
        time: '01:06 pm',
      },
      {
        id: 'm49',
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: 'm51',
        senderId: currentUser.id,
        text: 'Sure, just sent it on email.',
        time: '02:07 pm',
      },
      {
        id: 'm52',
        senderId: contactData[8].id,
        text: 'Got it. All good now.',
        time: '02:10 pm',
      },
    ],
  },
  {
    ...
    messages: [
      {
        id: 'm53',
        senderId: contactData[9].id,
        text: 'Just pushed a patch to fix that edge case.',
        time: '03:00 pm',
      },
      {
        id: 'm54',
        senderId: currentUser.id,
        text: 'Reviewing now. Will merge if it passes tests.',
        time: '03:05 pm',
      },
      {
        id: 'm55',
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: 'm60',
        senderId: currentUser.id,
        text: 'Yes, I’ll pull and test now.',
        time: '04:22 pm',
      },
      {
        id: 'm61',
