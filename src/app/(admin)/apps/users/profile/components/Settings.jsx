...
const Settings = () => {
  return (
    <>
      <h5 className="mb-base uppercase bg-default-50 p-1.25 text-sm border-dashed border rounded border-default-300 flex justify-center items-center gap-1.5">
        <Icon icon="user-circle" className="text-base" />
        Personal Info
      </h5>
      <div className="grid lg:grid-cols-2 grid-cols-1 gap-base mb-base">
        <div>
        ...
        <div className="lg:col-span-2 col-span-1">
          ...
          <input type="file" name="file-input" id="profilephoto" className="block w-full border border-default-300 rounded disabled:opacity-50 disabled:pointer-events-none file:bg-default-100 file:border-0 file:me-4 file:py-2 file:px-3" />
        </div>
      </div>
      <h5 className="mb-base uppercase bg-default-50 p-1.25 text-sm border-dashed border rounded border-default-300 flex justify-center items-center gap-1.5">
      ...
      <div className="grid lg:grid-cols-6 grid-cols-1 gap-base mb-base">
