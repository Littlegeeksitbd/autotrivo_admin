      ...
      <div className="card-header">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="items-center gap-3 md:flex">
            ...
            <div className="input-icon-group">
              <Icon icon="user-hexagon" className="input-icon" />
              <select className="form-select" value={table.getColumn('role')?.getFilterValue() ?? 'All'} onChange={(e) => table.getColumn('role')?.setFilterValue(e.target.value === 'All' ? undefined : e.target.value)}>
            ...
            <div className="card-body overflow-y-auto">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select className="form-textarea" id="userRole" multiple>
