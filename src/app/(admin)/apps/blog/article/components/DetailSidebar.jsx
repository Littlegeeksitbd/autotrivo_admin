  ...
  return (
    <>
      <div className="col-span-1">
        ...
        <div className="input-icon-group mb-12 md:mb-15">
          <Icon icon="search" className="input-icon" />
          <input type="text" className="form-input bg-light/25" placeholder="Search post..." />
        </div>

        <div className="mb-12 md:mb-15">
          <h5 className="mb-5 font-bold uppercase">Related post:</h5>
