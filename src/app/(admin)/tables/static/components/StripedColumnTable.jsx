          ...
          <table className="table">
            ...
            <tbody>
              {productsTable.data.slice(0, 3).map((product, idx) => (
                <tr key={idx}>
                  <td>{product.name}</td>
                  <td className="bg-default-100 px-2.25 py-3">{product.category}</td>
                  <td>${product.price.toFixed(2)}</td>
                  <td className="bg-default-100 px-2.25 py-3">{product.stock}</td>
                  <td>{product.rating} ★</td>
                  <td className="bg-default-100 px-2.25 py-3">
