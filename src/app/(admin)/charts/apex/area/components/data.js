...
// Splite Area
export const getSplineAreaChart = () => ({
  chart: {
    height: 380,
    type: 'area',
    toolbar: {
...
export const getAreaChartDateTimeChart = (filteredData = datetimeData) => ({
  annotations: {
    yaxis: [
      {
        y: 30,
...
export const getAreaWithNegativeChart = () => ({
  series: [
    {
      name: 'Payments',
  ...
  plotOptions: {
    line: {
      colors: {
        ...
        colorBelowThreshold: getColor('chart-alpha'),
      },
    },
  },
})
...
export const getAreaSelectionGithubChart = () => ({
  chart: {
    id: 'chartyear',
    type: 'area',
    height: 200,
...
export const getAreaSelectionGithubChart2 = () => ({
  chart: {
    height: 175,
    type: 'area',
    toolbar: {
...
export const getAreaTimeSeriesChart = () => ({
  chart: {
    type: 'area',
    stacked: false,
    height: 380,
...
export const getAreaChartWithNullValues = () => ({
  chart: {
    height: 380,
    type: 'area',
    toolbar: {
