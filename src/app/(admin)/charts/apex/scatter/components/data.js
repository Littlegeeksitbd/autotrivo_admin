...
export const getBasicScatter = () => ({
  ...
  colors: [getColor('chart-primary'), getColor('chart-beta'), getColor('chart-alpha')],
  xaxis: {
    tickAmount: 10,
  },
  yaxis: {
...
export const getDateTimeScatterChart = () => ({
  chart: {
    height: 380,
    type: 'scatter',
    zoom: {
  ...
  colors: [getColor('chart-secondary'), getColor('chart-zeta'), getColor('chart-delta'), getColor('chart-gray'), getColor('chart-secondary')],
  dataLabels: {
    enabled: false,
  },
  grid: {
...
export const getImageScatterChart = () => ({
  chart: {
    height: 380,
    type: 'scatter',
    animations: {
