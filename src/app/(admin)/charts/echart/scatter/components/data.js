...
const generateRandomData = (year) =>
  countries.map((country) => [
    ...
    // Life expectancy
    Math.floor(Math.random() * 1_000_000_000 + 5_000_000),
    // Population
    country,
    year,
  ])
  ...
  series: [
    {
      ...
      emphasis: {
        ...
        label: {
          ...
          show: true,
          formatter: (param) => (Array.isArray(param.data) ? param.data[3] : ''),
          position: 'top',
        },
      },
      itemStyle: {
        color: getColor('primary', 0.7),
      },
    },
    {
      name: '2015',
...
export const getQuartetScatterChart = () => ({
...
export const getSingleAxisScatterChart = () => ({
  tooltip: {
    trigger: 'item',
    padding: [5, 10],
    backgroundColor: getColor('secondary-bg'),
