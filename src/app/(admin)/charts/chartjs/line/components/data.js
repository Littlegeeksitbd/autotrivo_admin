    ...
    datasets: [
      {
        ...
        backgroundColor: getColor('chart-gamma', 0.2),
        borderWidth: 1.5,
        yAxisID: 'y',
        tension: 0.4,
      },
...
const down = (ctx, value) => (ctx.p0.parsed.y && ctx.p1.parsed.y && ctx.p0.parsed.y > ctx.p1.parsed.y ? value : undefined)
    ...
    datasets: [
      {
        ...
        spanGaps: true,
        segment: {
          borderColor: (ctx) => skipped(ctx, getColor('chart-dark', 0.2)) || down(ctx, getColor('danger')),
