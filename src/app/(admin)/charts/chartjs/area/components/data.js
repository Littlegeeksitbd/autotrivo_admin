    ...
    datasets: [
      {
        ...
        backgroundColor: getColor('chart-primary', 0.3),
    ...
    datasets: [
      {
        ...
        backgroundColor: getColor('chart-secondary', 0.2),
        tension: 0.4,
        pointRadius: 0,
        borderWidth: 1,
      },
  ...
  data: {
    ...
    datasets: [
      ...
      // Wave A - Primary Low
      {
        ...
        fill: true,
        borderColor: getColor('chart-secondary'),
        backgroundColor: getColor('chart-secondary', 0.1),
        tension: 0.5,
        pointRadius: 0,
        borderWidth: 1,
      },
      ...
      // Wave B - Secondary Low
      {
        ...
        backgroundColor: getColor('chart-beta', 0.1),
        tension: 0.5,
        pointRadius: 0,
        borderWidth: 1,
      },
    ...
    datasets: [
      {
        ...
        borderColor: getColor('chart-gray'),
        backgroundColor: getColor('chart-gray', 0.3),
        fill: true,
        borderWidth: 2,
      },
      {
        ...
        borderColor: getColor('chart-beta'),
        backgroundColor: getColor('chart-beta', 0.3),
        borderWidth: 2,
        tension: 0.2,
      },
    ],
  ...
  data: {
    ...
    datasets: [
      ...
      },
      {
        ...
        borderColor: getColor('chart-secondary'),
        fill: false,
        backgroundColor: getColor('chart-secondary', 0.3),
        borderWidth: 2,
      },
      {
        label: 'D2',
        ...
        fill: '-1',
        backgroundColor: getColor('chart-dark', 0.3),
        borderWidth: 2,
      },
      {
        label: 'D3',
